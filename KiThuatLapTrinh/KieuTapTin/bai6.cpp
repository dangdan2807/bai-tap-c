...
void read_file(long count[], long count2[],ifstream& infile);
void show_count(long Count[], long count2[], int n);
...
int main()
{
  ...
  read_file(array, array2, file_input);
  show_count(array, array2, CHAR_SIZE);
	file_input.close();
	return 0;
}
